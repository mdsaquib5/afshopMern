        ...
        <Slider {...heroSlider}>
          <div className="outline-none relative">
            <img
              ...
              height={900}
            />
            <div className="absolute inset-0 flex flex-col items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24">
              <h1 className="capitalize text-white text-3xl md:text-4xl lg:text-5xl font-bold text-start md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15">
                Freshness You can trust, saving you will love!
              </h1>
              <div className="flex items-center mt-6 font-medium">
                <Link
                  to={"/products"}
                  className="group group flex items-center gap-2 md:px-6 px-4 py-2 text-xs md:text-base lg:text-sm xl:text-lg text-black bg-white transition rounded cursor-pointer w-fit"
                >
